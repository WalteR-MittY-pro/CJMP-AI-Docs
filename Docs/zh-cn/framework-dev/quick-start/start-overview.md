...
```shell
sdkmanager --sdk_root=/path/to/your/sdk "platforms;android-26"
sdkmanager --sdk_root=/path/to/your/sdk "build-tools;34.0.0"
sdkmanager --sdk_root=/path/to/your/sdk "platform-tools"
sdkmanager --sdk_root=/path/to/your/sdk "ndk;27.2.12479018"
```
...
通过[华为开发者官网](https://developer.huawei.com/consumer/cn/deveco-studio/#download)下载 Command Line Tools 工具，推荐版本为 Command Line Tools 6.1.1 Release 及以上。注意安装路径中不要有空格或中文。
