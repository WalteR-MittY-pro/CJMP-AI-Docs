...
```cangjie
import cjmp.multimedia.camera.*
```

## 权限列表
| 平台      | 权限                                                                                                            |
| :-------- | :-------------------------------------------------------------------------------------------------------------- |
| HarmonyOS    | ohos.permission.CAMERA<br>ohos.permission.MICROPHONE |
| Android | android.permission.CAMERA<br>android.permission.RECORD_AUDIO<br>android.permission.WRITE_EXTERNAL_STORAGE（Android 8.0-9.0） |
| iOS | NSCameraUsageDescription<br>NSPhotoLibraryUsageDescription |
...
import cjmp.multimedia.camera.*
import cjmp.business_exception.BusinessException
import cjmp.hilog.Hilog
...
import cjmp.multimedia.camera.*
import cjmp.callback_invoke.Callback0Argument
import cjmp.business_exception.BusinessException
import cjmp.hilog.Hilog
...
import cjmp.multimedia.camera.*
import cjmp.business_exception.BusinessException
import cjmp.callback_invoke.Callback1Argument
import cjmp.hilog.Hilog
