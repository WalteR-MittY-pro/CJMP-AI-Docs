...
```cangjie
import cjmp.net.connection.*
```

## 权限列表
| 平台      | 权限                                                                                                            |
| :-------- | :-------------------------------------------------------------------------------------------------------------- |
| HarmonyOS | ohos.permission.GET_NETWORK_INFO<br>ohos.permission.INTERNET |
| Android   | android.permission.INTERNET<br>android.permission.ACCESS_NETWORK_STATE                                                                                                             |
| iOS       | 无需权限                                                                                                        |
...
import cjmp.business_exception.*
import cjmp.net.connection.*
