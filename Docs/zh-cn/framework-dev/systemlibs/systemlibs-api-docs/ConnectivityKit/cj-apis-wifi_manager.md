...
```cangjie
import cjmp.wifi_manager.*
```

## 权限列表
| 平台      | 权限                                                                                                            |
| :-------- | :-------------------------------------------------------------------------------------------------------------- |
| HarmonyOS | ohos.permission.GET_WIFI_INFO<br>ohos.permission.SET_WIFI_INFO |
| Android   | android.permission.ACCESS_WIFI_STATE<br>android.permission.ACCESS_COARSE_LOCATION 或 android.permission.ACCESS_FINE_LOCATION（Android 8.0-9.0）<br>android.permission.ACCESS_FINE_LOCATION（Android 10.0及以上） |
| iOS       | 无需权限 |
...
平台     | 权限                              |
|---------|-----------------------------------|
| HarmonyOS    | ohos.permission.GET_WIFI_INFO|
| Android | android.permission.ACCESS_WIFI_STATE<br>android.permission.ACCESS_COARSE_LOCATION 或 android.permission.ACCESS_FINE_LOCATION（Android 8.0-9.0）<br>android.permission.ACCESS_FINE_LOCATION（Android 10.0及以上） |
| iOS     | 无需权限 |
