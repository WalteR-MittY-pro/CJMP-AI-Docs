...
Three-argument event. Provides `on`/`off`/`emit` for subscribing to and triggering the event.
...
- description:Emits this event with `arg1`, `arg2`, `arg3`, invoking all currently registered callbacks in registration order.
- APILevel:12
- syscap: "SystemCapability.Ability.AbilityRuntime.Core"
